...
import no.snms.app.PreyCountDownTimer;
import no.snms.app.PreyOverView;
import no.snms.app.alarm.Alarm;
...
import no.snms.app.donation.DonationFragment;
import no.snms.app.images.ImageCacheManager;
import no.snms.app.jumma.JummaAdaptor;
import no.snms.app.jumma.JummaListner;
import no.snms.app.network.RequestManager;
import no.snms.app.news.BuildProjectListFragment;
import no.snms.app.news.EventListFragment;
import no.snms.app.news.NewsDetailsFragment;
...
import no.snms.app.qibla.QiblaFragment;
import no.snms.app.settings.SettingsFragment;
